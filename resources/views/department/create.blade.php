...
<div class="auth-card" style="max-width:600px">
    <div style="margin-bottom:24px">
        <h2 style="font-size:22px;font-weight:800;color:#0b044d;margin:0 0 6px">Add New Department</h2>
        <p style="font-size:13px;color:#6b6a8a;margin:0">Create a new organizational department</p>
    </div>

    <form action="{{ route('departments.store') }}" method='post' class="auth-form">
        @csrf

        <div class="auth-field">
            <label>Department Name <span style="color:#dc2626">*</span></label>
            <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Human Resources" required>
        </div>
