...
<div class="auth-root">
    ...
    <div class="auth-body">
        <div class="auth-page-head">
            <span class="pub-eyebrow">SECURITY CHECK</span>
            <h1 class="auth-page-title">Confirm Password</h1>
            <p class="auth-page-sub">Please confirm your password before continuing</p>
        </div>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="auth-form">
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-pw-wrap">
                        <input id="password" type="password" name="password" placeholder="Enter your password" required autocomplete="current-password" autofocus>
