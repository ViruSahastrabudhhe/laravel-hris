...
class EmployeeLeaveBalanceController extends Controller
{
    ...
    public function store(StoreEmployeeLeaveBalanceRequest $request)
    {
        ...
        return redirect()->route('employee_leave_balances.index')->with('success', __('leave_balance.success_creating'));
    }
    ...
    public function destroy(EmployeeLeaveBalance $employeeLeaveBalance)
    {
        ...
        return redirect()->route('employee_leave_balances.index')->with('success', __('leave_balance.success_deleting'));
    }
}
